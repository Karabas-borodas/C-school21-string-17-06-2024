...
static const char *const s21_errorlist[S21_ERRLIST_SIZE] = {
    [0] = "Undefined error: 0",
...
char *s21_strerror(int errnum) {
    static char res[S21_ERRLIST_SIZE] = {'\0'};

    if (errnum < 0 || errnum >= S21_ERRLIST_SIZE)
        printf(res, "Unknown error: %d", errnum);
    else
        strcpy(res, s21_errorlist[errnum]);
